...
export const columns: ColumnDef<ColumnSchema>[] = [
  {
    ...
    cell: ({ row }) => {
      const value = row.getValue("serialNumber") as string;
      return <TextWithTooltip text={value} />;
    },
    size: 200,
    minSize: 200,
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const value = row.getValue("manufacturingDate") as string;
  ...
  },
  {
    ...
    header: "Expiry Date",
    cell: ({ row }) => {
      const value = row.getValue("expiryDate") as string;
      return <div>{value}</div>;
    },
    size: 150,
    minSize: 150,
  },
  {
    ...
    header: "Lot Number",
    cell: ({ row }) => {
      const value = row.getValue("lotNumber") as string;
      return <TextWithTooltip text={value} />;
    },
    size: 130,
    minSize: 130,
  ...
  {
    accessorKey: "inInventoryOf",
    header: "In Inventory Of",
    cell: ({ row }) => {
      const value = row.getValue("inInventoryOf") as string;
      return <TextWithTooltip text={value} />;
    },
    size: 200,
    minSize: 200,
  ...
  {
    accessorKey: "supplyChainStatus",
    header: "Supply Chain Status",
    cell: ({ row }) => {
      const value = row.getValue("supplyChainStatus") as string;
      return <div>{value}</div>;
    },
    size: 150,
    minSize: 150,
  },
  {
    ...
    cell: ({ row }) => {
      const value = row.getValue("productStatus") as string;
      return <div>{value}</div>;
    },
    size: 150,
    minSize: 150,
  ...
  {
    accessorKey: "caseSSCC",
    header: "Case SSCC",
    cell: ({ row }) => {
      const value = row.getValue("caseSSCC") as string;
      return <TextWithTooltip text={value} />;
    },
    size: 200,
    minSize: 200,
  ...
  },
  {
    ...
    header: "Invoice Date",
    cell: ({ row }) => {
      const value = row.getValue("invoiceDate") as string;
      return <div>{value}</div>;
    },
    size: 150,
    minSize: 150,
  },
  {
    ...
    header: "Seller",
    cell: ({ row }) => {
      const value = row.getValue("seller") as string;
      return <TextWithTooltip text={value} />;
    },
    size: 200,
    minSize: 200,
  },
  {
    ...
    header: "Buyer",
    cell: ({ row }) => {
      const value = row.getValue("buyer") as string;
      return <div>{value}</div>;
    },
    size: 150,
    minSize: 150,
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const value = row.getValue("lastUpdatedOn") as string;
      return <div>{value}</div>;
    },
    size: 150,
    minSize: 150,
  ...
  {
    accessorKey: "isReactivated",
    header: "Is Reactivated",
    cell: ({ row }) => {
      const value = row.getValue("isReactivated") as string;
      return <div>{value}</div>;
    },
    size: 130,
    minSize: 130,
